...
<div id="checkout-cart" class="container">
      <div class="row">
        <div id="content" class="col-sm-12">
          ...
          <form action="http://thementic.com/opencart/OPC02/OPC0200032/index.php?route=checkout/cart/edit" method="post" enctype="multipart/form-data">
            <div class="table-responsive">
              <table class="table table-bordered shopping-cart">
                ...
                <tbody>
                  <tr>
                    <td class="text-center"> <a href="http://thementic.com/opencart/OPC02/OPC0200032/index.php?route=product/product&amp;product_id=40"><img src="./your bag_files/4-74x74.jpg" alt="consequat nibh" title="consequat nibh" class="img-thumbnail"></a> </td>
                    <td class="text-left"><a href="http://thementic.com/opencart/OPC02/OPC0200032/index.php?route=product/product&amp;product_id=40">consequat nibh</a>                                                 </td>
                    <td class="text-left">product 11</td>
                    <td class="text-left">
                      <div class="input-group btn-block" style="max-width: 200px;">
                        <input type="text" name="quantity[132]" value="1" size="1" class="form-control">
                        ...
                        <button type="button" data-toggle="tooltip" title="" class="btn btn-danger" onclick="cart.remove(&#39;132&#39;);" data-original-title="Remove"><i class="fa fa-times-circle"></i></button>
                        </span>
                      </div>
                    </td>
          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"><a href="http://thementic.com/opencart/OPC02/OPC0200032/#collapse-coupon" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion">Use Coupon Code <i class="fa fa-caret-down"></i></a></h4>
              </div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"><a href="http://thementic.com/opencart/OPC02/OPC0200032/#collapse-shipping" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion">Estimate Shipping &amp; Taxes <i class="fa fa-caret-down"></i></a></h4>
              </div>
                ...
                <div class="panel-body">
                  ...
                  <div class="form-horizontal">
                    <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                        <select name="country_id" id="input-country" class="form-control hasCustomSelect" style="-webkit-appearance: menulist-button; width: 100px; position: absolute; opacity: 0; height: 0px; font-size: 14px;">
                        ...
                        <span class="customSelect form-control customSelectDisabled" style="display: inline-block;"><span class="customSelectInner" style="width: 95px; display: inline-block;">United Kingdom</span></span>
                      </div>
                    </div>
                    <div class="form-group required">
                      <label class="col-sm-2 control-label" for="input-zone">Region / State</label>
                      <div class="col-sm-10">
                        <select name="zone_id" id="input-zone" class="form-control hasCustomSelect" style="-webkit-appearance: menulist-button; width: 100px; position: absolute; opacity: 0; height: 0px; font-size: 14px;">
                          <option value=""> --- Please Select --- </option>
                        ...
                        <span class="customSelect form-control" style="display: inline-block;"><span class="customSelectInner" style="width: 95px; display: inline-block;">&nbsp;</span></span>
                      </div>
                    </div>
                    <div class="form-group required">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"><a href="http://thementic.com/opencart/OPC02/OPC0200032/#collapse-voucher" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle">Use Gift Certificate <i class="fa fa-caret-down"></i></a></h4>
              </div>
          ...
          <div class="buttons clearfix">
            <div class="pull-left"><a href="http://thementic.com/opencart/OPC02/OPC0200032/index.php?route=common/home" class="btn btn-default">Continue Shopping</a></div>
            <div class="pull-right"><a href="http://thementic.com/opencart/OPC02/OPC0200032/index.php?route=checkout/checkout" class="btn btn-primary">Checkout</a></div>
          </div>
        </div>
      </div>
    </div>
