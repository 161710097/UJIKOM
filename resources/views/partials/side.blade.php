        ...
        <div class="sidebar-content">
          ...
          <nav class="main-menu">
            <ul class="nav metismenu">
              ...
              <li class="nav-dropdown">
                <a href="{{ route('contact.index') }}" aria-expanded="false"><i class="icon dripicons-blog"></i><span>DATA CONTACT</span></a>
              </li>
              <li class="nav-dropdown">
                <a href="{{ route('testimoni.index') }}" aria-expanded="false"><i class="icon dripicons-blog"></i><span>DATA TESTIMONIAL</span></a>
              </li>
              <li class="nav-dropdown">
                <a href="{{ route('kategoriartikel.index') }}" aria-expanded="false"><i class="icon dripicons-blog"></i><span>DATA KATEGORI ARTIKEL</span></a>
              </li>
              <li class="nav-dropdown">
                <a href="{{ route('artikel.index') }}" aria-expanded="false"><i class="icon dripicons-blog"></i><span>DATA ARTIKEL</span></a>
              </li>
              <li class="nav-dropdown">
                <a href="{{ route('merk.index') }}" aria-expanded="false"><i class="icon dripicons-blog"></i><span>DATA MERK</span></a>
              </li>
              <li class="nav-dropdown">
                <a href="{{ route('kategoriproduk.index') }}" aria-expanded="false"><i class="icon dripicons-blog"></i><span>DATA KATEGORI PRODUK</span></a>
              </li>
              <li class="nav-dropdown">
              ...
              <li class="nav-dropdown">
                <a href="{{ route('transaksi.index') }}" aria-expanded="false"><i class="icon dripicons-blog"></i><span>DATA TRANSAKSI</span></a>
              </li>
