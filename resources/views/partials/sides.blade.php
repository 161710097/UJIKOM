                    ...
                    <div class="row m-0">
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-a.css')}}">
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-b.css')}}">
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-c.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-dark"></span>
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-d.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-dark"></span>
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-e.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-dark"></span>
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-f.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-dark"></span>
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-g.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-dark"></span>
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-h.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-dark"></span>
                    ...
                    <div class="row m-0">
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-i.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-j.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-light"></span>
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-k.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-light"></span>
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-l.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-light"></span>
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-m.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-light"></span>
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-n.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-light"></span>
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-o.css')}}">
                          <input type="radio" name="setting-theme">
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-light"></span>
                      ...
                      <div class="col-6 col-md-3 p-5 m-b-10">
                        <div class="color-option-check">
                          ...
                          <label data-load-css="{{asset('admin/css/layouts/vertical/themes/theme-p.css')}}">
                          <input type="radio" name="setting-theme" />
                          <span class="icon-check"></span>
                          <span class="split">
                          <span class="color bg-menu-light"></span>
                  ...
                  <div class="qt-scroll" data-scroll="minimal-dark">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="John Smith">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/01.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="Allison Grayce">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/06.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/07.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/11.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="John Smith">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/02.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="Allison Grayce">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/16.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/08.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/13.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="John Smith">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/03.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="Allison Grayce">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/12.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/09.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="John Smith">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/04.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="Allison Grayce">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/05.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/14.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/10.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/18.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/17.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/20.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/21.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/22.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/23.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/25.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                      ...
                      <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/26.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
                    ...
                    <ul class="list-group p-0">
                      <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                        <span class="float-left"><img src="{{asset('admin/img/avatars/27.jpg')}}" alt="" class="rounded-circle max-w-50 m-r-10"></span>
                        <i class="badge mini success status"></i>
                        <div class="list-group-item-body">
