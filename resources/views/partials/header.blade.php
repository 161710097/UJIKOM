        ...
        <nav class="top-toolbar navbar navbar-desktop flex-nowrap">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <figure class="tint">
                      ...
                      <img src="{{asset('admin/img/demos/ecom-header.jpg')}}" alt="">
                    </figure>
                  </div>
                </div>
              </div>
          ...
          <ul class="navbar-nav nav-right">
            ...
            <li class="nav-item dropdown">
              ...
              <img src="{{asset('admin/img/avatars/1.jpg')}}" class="w-35 rounded-circle" alt="Albert Einstein">
              </a>
              <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                <div class="dropdown-header pb-3">
                  <div class="media d-user">
                    <img class="align-self-center mr-3 w-40 rounded-circle" src="{{asset('admin/img/avatars/1.jpg')}}" alt="Albert Einstein">
