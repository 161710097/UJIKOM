...
<html lang="en">
  ...
  <head>
    ...
    <title>IstanaHelmet | Bandung</title>
    <!-- ================== GOOGLE FONTS ==================-->
    ...
    <link href="{{asset('admin/css/selectize.bootstrap3.css')}}" rel="stylesheet">
  </head>
  <body>
    <!-- START APP WRAPPER -->
    <div id="app">
    ...
    <script src="{{asset('admin/vendor/jquery.flot.tooltip/js/jquery.flot.tooltip.min.js')}}"></script>
    ...
    <script src="{{asset('admin/js/cards/recent-transactions.js')}}"></script>
    <script src="{{asset('admin/js/cards/monthly-budget.js')}}"></script>
...
sortField: 'text'
    ...
    <script src="{{asset('admin/js/kategoriproduk.js')}}"></script>
    <script src="{{asset('admin/js/testimoni.js')}}"></script>
    <script src="{{asset('admin/js/format.js')}}"></script>
     @yield('scripts')
  </body>
